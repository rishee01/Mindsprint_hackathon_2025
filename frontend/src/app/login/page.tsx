    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Sign in to continue to CivicSense</p>
        </div>
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg">
          ...
          <p className="text-sm text-blue-700 mt-1">Admin: admin@civicsense.com / admin123</p>
          <p className="text-sm text-blue-700">User: user1@example.com / user123</p>
        </div>
      </div>
    </div>
  );
